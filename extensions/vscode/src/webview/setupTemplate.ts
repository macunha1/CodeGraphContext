  ...
  return `<!DOCTYPE html>
    ...
    <body>
        <div class="container">
            ...
            <div class="field"><label>Database Mode</label><select id="dbMode"><option value="falkordb" ${dbMode === "falkordb" ? "selected" : ""}>FalkorDB (Redis-based)</option><option value="ladybugdb" ${dbMode === "ladybugdb" ? "selected" : ""}>LadybugDB (Embedded)</option><option value="neo4j" ${dbMode === "neo4j" ? "selected" : ""}>Neo4j</option></select></div>
